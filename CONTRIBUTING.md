...
We welcome documentation improvements. See [acl/docs in azure-container-linux](https://github.com/microsoft/azure-container-linux/tree/main/acl/docs) for the latest documentation.
...
* Ensure that you can build and boot the image following the [building instructions in azure-container-linux](https://github.com/microsoft/azure-container-linux/tree/main/acl/docs/BUILD_RPM_IMAGE_README.md) and ensure that the changes to the test code is passing validation. 

* Updated [disabled](acl-disabled-tests.md) and [enforcing](https://github.com/microsoft/azure-container-linux/blob/main/acl/tests/kola_enforcing.yaml) tests as appropriate.
